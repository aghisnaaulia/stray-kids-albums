        ...
        var query = connection.query(
          ...
          function (err, result) {
            if (err) {
              ...
              req.flash("msg_info", "Data deleted!");
              res.redirect("/customers");
            }
          }
        );
...
router.put(
  ...
  authentication_mdl.is_login,
  function (req, res, next) {
    req.assert("name", "Please edit the title and version!").notEmpty();
        ...
        var query = connection.query(
          ...
          function (err, result) {
            if (err) {
              ...
              req.flash("msg_info", "Data edited!");
...
router.post("/add", authentication_mdl.is_login, function (req, res, next) {
  req.assert("name", "Please fill the title and version!").notEmpty();
  var errors = req.validationErrors();
  if (!errors) {
    v_name = req.sanitize("name").escape().trim();
